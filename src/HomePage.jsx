  ...
  return (
    <div className="bg-[#F5F1EB] text-[#2C2C2C] min-h-screen font-sans">
      ...
      <section className="py-16 px-6 text-center">
        <img src={edith} alt="Edith Image"  className="w-38 h-38 rounded-full mx-auto mb-4" />
      ...
      <section className="py-12 px-6 grid md:grid-cols-3 gap-8 text-center">
        <div className="bg-white p-6 rounded shadow">
           <img src={compass} alt="Edith Image"  className="w-24 h-24  mx-auto mb-4" />
        ...
        <div className="bg-white p-6 rounded shadow">
           <img src={weeg} alt="Edith Image"  className="w-24 h-24  mx-auto mb-4" />
        ...
        <div className="bg-white p-6 rounded shadow">
           <img src={oor} alt="Edith Image"  className="w-24 h-24  mx-auto mb-4" />
